...
import { Cpu, Activity, Radio, Server, ShieldCheck, Zap } from 'lucide-react';
  ...
  return (
    <section className="py-12 sm:py-16 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-[24px] bg-gradient-to-b from-[#111111] via-[#121212] to-[#0D0D0D] border border-[#252525] p-6 sm:p-10 lg:p-12 overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.9)]">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-5 text-left">
              ...
              <div className="grid grid-cols-3 gap-3 pt-2">
                <div className="p-3.5 rounded-xl bg-[#0D0D0D] border border-[#252525]">
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative w-full max-w-sm rounded-2xl bg-[#0D0D0D] border border-[#252525] p-5 shadow-2xl overflow-hidden group hover:border-[#FF1F26]/60 transition-colors">
                ...
                {/* Small Floating Card over image: AVAURA - Building intelligent solutions for the future. */}
