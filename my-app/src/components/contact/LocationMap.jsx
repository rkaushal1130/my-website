        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-8 relative rounded-2xl sm:rounded-3xl bg-[#0A0A0D] border border-[#222226] overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.95)] min-h-[340px] sm:min-h-[460px] flex flex-col group">
            ...
            <div className="absolute top-3 sm:top-4 left-3 sm:left-4 right-3 sm:right-4 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-2 pointer-events-none">
              <div className="px-3 py-1.5 sm:px-3.5 sm:py-1.5 rounded-xl bg-[#0D0D0D]/90 border border-[#26262B] backdrop-blur-md text-[11px] sm:text-xs font-semibold text-white flex items-center gap-2 shadow-lg w-fit">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="pointer-events-auto px-3 py-1.5 sm:px-3.5 sm:py-1.5 rounded-xl bg-[#0D0D0D]/90 hover:bg-[#FF1F26] border border-[#26262B] hover:border-[#FF1F26] backdrop-blur-md text-[11px] sm:text-xs font-semibold text-[#A7A7A7] hover:text-white flex items-center gap-1.5 transition-all shadow-lg w-fit"
              >
