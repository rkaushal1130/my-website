      ...
      <div className="max-w-[1760px] mx-auto px-6 sm:px-10 md:px-14 lg:px-20 xl:px-24 2xl:px-28 relative z-10 w-full">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="w-full max-w-4xl xl:max-w-5xl 2xl:max-w-6xl text-center flex flex-col items-center space-y-7 sm:space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#101010] border border-[#242424] text-xs font-semibold tracking-wider text-[#FF1F26] uppercase shadow-[0_0_15px_rgba(255,31,38,0.15)]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#101010] border border-[#26262B] text-white text-base font-semibold hover:border-[#FF1F26] hover:bg-[#18181D] active:scale-[0.98] transition-all duration-300 cursor-pointer"
              >
