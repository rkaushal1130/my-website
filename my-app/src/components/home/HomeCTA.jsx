  ...
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden bg-[#030303]">
      <Container size="wide">
        ...
        <div className="relative rounded-[24px] sm:rounded-[28px] bg-gradient-to-b from-[#101010] to-[#080808] border border-[#242424] p-6 sm:p-10 md:p-14 lg:p-16 xl:p-20 overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.9)] hover:border-[#FF1F26]/35 transition-all duration-400">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-8 space-y-4 sm:space-y-5 text-left">
              ...
              <div className="pt-2 sm:pt-3 flex flex-wrap items-center gap-3.5 sm:gap-7 text-xs sm:text-sm text-[#737373] font-medium">
