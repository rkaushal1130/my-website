          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-6 relative z-10">
            {reasons.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="group relative p-6 sm:p-8 rounded-[20px] bg-[#171717] border border-[#242424] hover:border-[#FF1F26]/55 transition-all duration-300 hover:shadow-card-hover hover:-translate-y-2 flex flex-col justify-between"
                >
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="relative">
                      ...
                      <div className="w-9 h-9 rounded-full bg-[#0D0D0D] border-2 border-[#FF1F26] flex items-center justify-center text-xs font-bold text-[#FF1F26] shadow-[0_0_12px_rgba(255,31,38,0.4)]">
                        {item.number}
                      </div>
                    </div>
