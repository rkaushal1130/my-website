...
import { X, Play, Pause, Volume2, VolumeX, Maximize2, Cpu, Activity, Database, CheckCircle2 } from 'lucide-react';
      ...
      <div className="relative w-full max-w-4xl rounded-3xl bg-[#0B0B0B] border border-[#242424] shadow-[0_0_60px_rgba(255,31,38,0.3)] overflow-hidden z-10 transition-all my-8">
        ...
        <div className="relative aspect-video bg-[#050505] overflow-hidden flex flex-col justify-between p-6 sm:p-8">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="flex items-center gap-2 px-3 py-1 rounded-md bg-[#111111]/80 border border-[#242424] text-xs font-mono text-[#FF2B30]">
              <Cpu className="w-3.5 h-3.5 text-[#FF1F26]" />
              <span>CLUSTER: NQ-GPU-NODE-09</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-1 rounded-md bg-[#111111]/80 border border-[#242424] text-xs font-mono text-[#B5B5B5]">
              <Activity className="w-3.5 h-3.5 text-[#FF1F26]" />
              <span>LATENCY: 14ms (p99)</span>
            </div>
          </div>

          {/* Center Visual Demo Content based on active tab */}
              ...
              <div className="space-y-4 max-w-lg mx-auto">
                ...
                <div className="flex justify-center gap-2">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div
                      key={i}
                      className="w-12 h-1.5 rounded-full bg-[#242424] overflow-hidden"
                    >
                      <div
          ...
          <div className="relative z-10 space-y-3">
            {/* Scrubber Bar */}
            <div 
              className="w-full h-1.5 bg-[#242424] rounded-full overflow-hidden cursor-pointer group"
              onClick={(e) => {
            ...
            >
              <div 
                className="h-full bg-gradient-to-r from-[#FF1F26] to-[#FF2B30] relative"
            ...
            <div className="flex items-center justify-between text-white text-xs">
              <div className="flex items-center gap-3">
                <button 
                  ...
                  className="w-8 h-8 rounded-lg bg-[#111111] border border-[#242424] hover:border-[#FF1F26] flex items-center justify-center text-white transition-colors"
                >
                ...
                <button 
                  ...
                  className="w-8 h-8 rounded-lg bg-[#111111] border border-[#242424] hover:border-[#FF1F26] flex items-center justify-center text-[#B5B5B5] hover:text-white transition-colors"
                >
              ...
              {/* Feature tabs within video */}
              <div className="hidden sm:flex items-center gap-1 bg-[#111111] p-1 rounded-lg border border-[#242424]">
                <button
                  onClick={() => setActiveTab('pipeline')}
                  className={`px-2.5 py-1 rounded text-[11px] font-medium transition-colors ${
                    activeTab === 'pipeline' ? 'bg-[#FF1F26] text-white' : 'text-[#B5B5B5] hover:text-white'
                  }`}
                >
                  Pipeline
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded text-[11px] font-medium transition-colors ${
                    activeTab === 'neural' ? 'bg-[#FF1F26] text-white' : 'text-[#B5B5B5] hover:text-white'
                  }`}
                >
                  Neural Core
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded text-[11px] font-medium transition-colors ${
                    activeTab === 'agents' ? 'bg-[#FF1F26] text-white' : 'text-[#B5B5B5] hover:text-white'
                  }`}
                >
                  Agent Swarm
                </button>
              ...
              <div className="flex items-center gap-2">
                <span className="text-[10px] uppercase font-mono px-2 py-0.5 rounded bg-[#FF1F26]/20 text-[#FF2B30] border border-[#FF1F26]/40">
                  4K ULTRA HD
                </span>
