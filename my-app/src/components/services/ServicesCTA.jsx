    ...
    <section className="py-20 sm:py-28 relative overflow-hidden bg-[#030303]">
      <Container size="wide">
        ...
        <div className="relative rounded-[24px] sm:rounded-[28px] bg-gradient-to-b from-[#101010] to-[#080808] border border-[#242424] p-6 sm:p-10 md:p-14 lg:p-16 overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.9)] hover:border-[#FF1F26]/35 transition-all duration-400">
          ...
          <div className="absolute right-[-60px] sm:right-0 lg:right-10 top-1/2 -translate-y-1/2 w-[260px] sm:w-[380px] h-[260px] sm:h-[380px] opacity-25 pointer-events-none flex items-center justify-center">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 space-y-4 text-left">
              ...
              <p className="text-sm sm:text-lg text-[#A7A7A7] leading-relaxed max-w-xl font-normal">
                Schedule a 30-minute architecture session with our AI engineering leads to map out your technical requirements.
              </p>

              <div className="pt-2 flex flex-wrap items-center gap-3.5 sm:gap-5 text-xs text-[#737373] font-medium">
            ...
            <div className="lg:col-span-4 flex flex-col items-start lg:items-end justify-center w-full">
              <button
                type="button"
                onClick={onOpenDemo}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-7 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-[#FF1F26] text-white text-base font-bold shadow-[0_0_25px_rgba(255,31,38,0.3)] hover:bg-[#FF3030] hover:shadow-[0_0_35px_rgba(255,31,38,0.5)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 group cursor-pointer"
              >
