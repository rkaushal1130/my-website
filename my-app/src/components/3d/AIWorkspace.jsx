  ...
  return (
    <Float speed={1.8} rotationIntensity={0.2} floatIntensity={0.4}>
      <group ref={groupRef}>
        ...
        {/* Floating Dark Metallic Workstation Desk */}
        ...
        {/* Main Center Holographic Screen */}
        ...
        {/* Left Angled Code / Telemetry Screen */}
        ...
        {/* Right Angled Holographic Graph Screen */}
        ...
        {/* Center Floating AI Holographic Core / Graph */}
